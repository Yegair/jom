...
class SequencesTest
{
    @Test
    void delimited() {
        final Parser<String> parser = Sequences.delimited(
            TextParsers.tag("abc"),
            TextParsers.tag("|"),
            TextParsers.tag("efg")
        );
    ...
    @Test
    void pair() {
        final Parser<Pair<String, String>> parser = Sequences.pair(
            TextParsers.tag("abc"),
            TextParsers.tag("efg")
        );
    ...
    @Test
    void preceded() {
        final Parser<String> parser = Sequences.preceded(
            TextParsers.tag("abc"),
            TextParsers.tag("efg")
        );
    ...
    void separatedPair()
    {
        final Parser<Pair<String, String>> parser = Sequences.separatedPair(
            TextParsers.tag("abc"),
            TextParsers.tag("|"),
            TextParsers.tag("efg")
        );
    ...
    @Test
    void terminated() {
        final Parser<String> parser = Sequences.terminated(
            TextParsers.tag("abc"),
            TextParsers.tag("efg")
        );
    ...
    @Test
    void triple() {
        final Parser<Triple<String, String, String>> parser = Sequences.triple(
            TextParsers.alpha1(),
            TextParsers.digit1(),
            TextParsers.alpha1()
        );
