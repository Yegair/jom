...
class TextParsersTest {
    ...
    void alpha0() {
        ...
        assertThatParseResult(parser.parse(Input.of("ab1c"))).isOk("ab").hasRemainingInput("1c");
    }
    ...
    void anyChar() {
        ...
        assertThatParseResult(parser.parse(Input.of("abc"))).isOk('a').hasRemainingInput("bc");
    }
    ...
    void digit0() {
        ...
        assertThatParseResult(parser.parse(Input.of("21c"))).isOk("21").hasRemainingInput("c");
    }
    ...
    void noneOf() {
        ...
        assertThatParseResult(parser.parse(Input.of("z"))).isOk("z").hasRemainingInput("");
    }
    ...
    void octDigit0() {
        ...
        assertThatParseResult(parser.parse(Input.of("678"))).isOk("67").hasRemainingInput("8");
    }
    ...
    void tab() {
        ...
        assertThatParseResult(parser.parse(Input.of("\t c"))).isOk('\t').hasRemainingInput(" c");
    }
